namespace JsonConversionsDemo
{
    ...
    internal static class Program
    {
        private static void Run()
        {
            ...
            JsonConvert.Export(shape, JsonText.CreatePrettyWriter(Console.Out));
            Console.WriteLine();
            ...
            JsonConvert.Export(cookies, JsonText.CreatePrettyWriter(Console.Out));
            Console.WriteLine();
            ...
            expctx.Export(cookies, JsonText.CreatePrettyWriter(Console.Out));
            Console.WriteLine();
        }

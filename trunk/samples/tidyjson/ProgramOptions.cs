namespace TidyJson
{
    ...
    internal sealed class ProgramOptions
    {
        ...
        public string[] Parse(string[] args)
        {
            ...
            Queue<string> inputs = new Queue<string>(args);
            Queue<string> anonymous = new Queue<string>(args.Length);

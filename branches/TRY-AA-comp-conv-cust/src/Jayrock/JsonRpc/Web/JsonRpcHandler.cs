        ...
        private static IDictionary DefaultFeatures
        {
            get 
            {
                ...
                if (config == null)
                {
                    ...
                    config.Add("proxy", typeof(JsonRpcProxyGenerator).FullName); 
                    config.Add("help", typeof(JsonRpcHelp).FullName); 
                    config.Add("test", typeof(JsonRpcTester).FullName); 
                    config.Add("getrpc", typeof(JsonRpcGetProtocol).FullName); 
                    config.Add("pyproxy", typeof(JsonRpcPythonProxyGenerator).FullName); 

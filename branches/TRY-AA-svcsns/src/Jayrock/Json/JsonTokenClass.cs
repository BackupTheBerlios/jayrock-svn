namespace Jayrock.Json
{
    ...
    public sealed class JsonTokenClass : IObjectReference
    {
        ...
        public static readonly JsonTokenClass EndArray = new JsonTokenClass("EndArray");
        public static readonly JsonTokenClass Object = new JsonTokenClass("Object");
        public static readonly JsonTokenClass EndObject = new JsonTokenClass("EndObject");
        public static readonly JsonTokenClass Member = new JsonTokenClass("Member");
        public static readonly JsonTokenClass BOF = new JsonTokenClass("BOF");
        public static readonly JsonTokenClass EOF = new JsonTokenClass("EOF");
